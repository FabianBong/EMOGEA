...
if __name__ == "__main__":
    ...
    """
    This script demonstrates how to use the EMOGEA package to perform multivariate curve resolution on a sample dataset.
    It executes every function in the package and prints the results.
    """
